...
function WorkerSolvedTable() {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:5000/api/complaints/worker/solved', {
        headers: {
      ...
      console.error('Error fetching solved worker complaints:', error.response ? error.response.data : error.message);
    }
  };
...
export default WorkerSolvedTable;