...
import './AdminSolvedComplain.css';
import person from '../assets/person.jpg'

const AdminSolvedComplain = () => {
        ...
        <div className="complaint-form">
          ...
          <div className="form-actions">
            ...
            <div className="status-group">
              <button className="reminder-btn" onClick={handleSolved}>SOLVED</button>
            </div>
          </div>
...
export default AdminSolvedComplain;