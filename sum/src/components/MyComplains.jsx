...
const MyComplains = () => {
  ...
  useEffect(() => {
    ...
    setComplaints([
      { id: '1', serviceDetails: 'ELECTRICAL', dateTime: '2024-09-29 10:00', status: 'Solved', moreDetails: 'Details' },
      { id: '2', serviceDetails: 'PLUMBING', dateTime: '2024-09-28 14:30', status: 'In-Progress', moreDetails: 'Details' },
    ]);
  }, []);
